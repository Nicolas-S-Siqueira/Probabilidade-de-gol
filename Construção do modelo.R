...
rec <- recipe(shot_outcome_name ~ 
  ...
  #o ideal é q a soma da probabilidade de cada finalização seja igual ao total real de gols
  ...
  step_dummy(all_nominal(), -all_outcomes()) #hot encoding em todas as variáveis explicativas nominais. (nesse caso todas as explicativas)
...
#mixture = 0 significa q é uma regressão ridge (sem lasso)
